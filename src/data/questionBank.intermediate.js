...
export const intermediateQuestions = [
  ...
  // ---------------------------------------------------------------
  {
    ...
    options: [
      { ar: "الاسبوع الجاي", translit: "Al-usboo9 al-jaay" },
      { ar: "الاسبوع الماضي", translit: "Al-usboo9 al-maaDi" },
      { ar: "بعد اسبوع", translit: "Ba9ad usboo9" },
      { ar: "بكرة", translit: "Bakra" },
    ],
    correctIndex: 1,
    explanation: {
      en: '"Al-usboo9 al-maaDi" means "last week." "Al-usboo9 al-jaay" is "next week," "ba9ad usboo9" is "in a week," and "bakra" is "tomorrow."',
      ar: '"الاسبوع الماضي" تعني last week. "الاسبوع الجاي" تعني next week، "بعد اسبوع" تعني in a week، و"بكرة" تعني tomorrow.',
    },
  },
  {
    id: "int-vocab-002",
  ...
  // ---------------------------------------------------------------
  {
    ...
    prompt: { en: 'How do you say "we worked yesterday"?' },
    options: [
      { ar: "اشتغلنا امبارح", translit: "Ishtaghalna imbaariH" },
      { ar: "اشتغلتوا امبارح", translit: "Ishtaghaltoo imbaariH" },
      { ar: "اشتغلت امبارح", translit: "Ishtaghalat imbaariH" },
      { ar: "اشتغلوا امبارح", translit: "Ishtaghaloo imbaariH" },
    ],
    correctIndex: 0,
    explanation: {
      en: '"niHna" (we) takes the past-tense suffix "-na": "ishtaghalna" = "we worked."',
      ar: '"نحنا" تأخذ لاحقة الماضي "-na": "ishtaghalna" تعني "we worked".',
    },
  },
  {
    id: "int-verb-002",
    type: "mcq",
    category: "verbs_with_pronouns",
    prompt: { en: 'How do you say "they went to the house two days ago"?' },
    options: [
      { ar: "راحوا البيت قبل يومين", translit: "RaaHoo al-beet gabel yomeyn" },
      { ar: "رحنا البيت قبل يومين", translit: "RiHna al-beet gabel yomeyn" },
      { ar: "راحت البيت قبل يومين", translit: "RaaHat al-beet gabel yomeyn" },
      { ar: "رحت البيت قبل يومين", translit: "RiHt al-beet gabel yomeyn" },
    ],
    correctIndex: 0,
    explanation: {
      en: '"hoom" (they) takes the irregular past form "raaHoo" for "rooH" (go), not a regular suffix.',
      ar: '"هم" تأخذ صيغة الماضي غير القياسية "raaHoo" للفعل "rooH" (ذهب)، وليست لاحقة قياسية.',
    },
  },
  {
    id: "int-verb-003",
  ...
  },
  {
    ...
    type: "mcq",
    category: "verbs_with_pronouns",
    prompt: { en: 'Fix the mistake: "Hiya ma ishtaghal al-yoom." What is wrong?' },
    options: [
      "Nothing, it's correct",
      "Should be \"ishtaghalat,\" since \"hiya\" takes the feminine past suffix \"-at\"",
      "Should use \"muu\" instead of \"ma\"",
      "Should be future tense, not past",
    ],
    correctIndex: 1,
    explanation: {
      en: '"Hiya" (she) needs the "-at" suffix even in a negative sentence: the correct form is "Hiya ma ishtaghalat al-yoom" (she didn\'t work today).',
      ar: '"هي" تحتاج لاحقة "-at" حتى في الجملة المنفية: الصيغة الصحيحة هي "Hiya ma ishtaghalat al-yoom".',
    },
  },
  ...
  // ---------------------------------------------------------------
  {
    ...
    options: [
      { ar: "سيارةها", translit: "Sayaaraha" },
      { ar: "سيارتها", translit: "Sayaartha" },
      { ar: "سيارةهها", translit: "Sayaarahha" },
      { ar: "سيارةتها", translit: "Sayaaratha" },
    ],
    correctIndex: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { ar: "غرفةنا", translit: "Ghurfana" },
      { ar: "غرفتنا", translit: "Ghurftna" },
      { ar: "غرفةتنا", translit: "Ghurfatna" },
      { ar: "غرفنا", translit: "Ghurfna" },
    ],
    correctIndex: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { ar: "مدرسةهم", translit: "Madrasahum" },
      { ar: "مدرسةتاهم", translit: "Madrastahum" },
      { ar: "مدرستهم", translit: "Madrasthum" },
      { ar: "مدرسةاتهم", translit: "Madrasatuhum" },
    ],
    correctIndex: 2,
    explanation: {
  ...
  // ---------------------------------------------------------------
  {
    ...
    options: [
      { ar: "كنت في البيت، بس براوح الشغل بكرة", translit: "Kunt fi al-beet, bass b-arooH ash-shughul bakra" },
      { ar: "انا في البيت، بس اروح الشغل بكرة", translit: "Ana fi al-beet, bass arooH ash-shughul bakra" },
      { ar: "كنت في البيت، بس رحت الشغل بكرة", translit: "Kunt fi al-beet, bass riHt ash-shughul bakra" },
      { ar: "كنت في البيت، بس اروح الشغل بكرة", translit: "Kunt fi al-beet, bass arooH ash-shughul bakra" },
    ],
    correctIndex: 0,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { ar: "ما ب تروحون عشان انتوا تعبانين", translit: "Ma b-trooHoon 9ashaan intoo ta9baaneen" },
      { ar: "ما رحتوا عشان انتوا تعبانين", translit: "Ma riHtoo 9ashaan intoo ta9baaneen" },
      { ar: "ب تروحون عشان انتوا تعبانين", translit: "B-trooHoon 9ashaan intoo ta9baaneen" },
      { ar: "ما تروحون عشان انتوا تعبانين", translit: "Ma trooHoon 9ashaan intoo ta9baaneen" },
    ],
    correctIndex: 0,
    explanation: {
  ...
  // ---------------------------------------------------------------
  {
    ...
    options: [
      { ar: "هو مو موجود", translit: "Hoo muu mawjood" },
      { ar: "ماهو موجود", translit: "Maahu mawjood" },
      { ar: "ما هو موجود", translit: "Ma hoo mawjood" },
      { ar: "مو هو موجود", translit: "Muu hoo mawjood" },
    ],
    correctIndex: 1,
    explanation: {
  ...
  // ---------------------------------------------------------------
  {
    ...
    type: "mcq",
    category: "tenses",
    prompt: { en: 'Choose the correct translation: "I have a meeting tomorrow, I will not go to the market."' },
    options: [
      { ar: "عندي اجتماع بكرة، ما ب اروح السوق", translit: "9indi ijtimaa9 bakra, ma b-arooH as-sooq" },
      { ar: "كان عندي اجتماع بكرة، ما رحت السوق", translit: "Kaan 9indi ijtimaa9 bakra, ma riHt as-sooq" },
      { ar: "عندي اجتماع امبارح، ب اروح السوق", translit: "9indi ijtimaa9 imbaariH, b-arooH as-sooq" },
      { ar: "ما عندي اجتماع بكرة، ب اروح السوق", translit: "Ma 9indi ijtimaa9 bakra, b-arooH as-sooq" },
    ],
    correctIndex: 0,
    explanation: {
      en: '"9indi ijtimaa9 bakra" (I have a meeting tomorrow) sets up the reason, and "ma b-arooH as-sooq" (I will not go to the market) gives the future-tense, negated result.',
      ar: '"عندي اجتماع بكرة" (لدي اجتماع غدا) تمهد للسبب، و"ما ب اروح السوق" (لن أذهب للسوق) تعطي النتيجة بصيغة المستقبل المنفية.',
    },
  },
  {
    id: "int-sent-002",
  ...
  },
  {
    ...
    options: [
      { ar: "بيتهم مو كبير، بس بيتنا كبير", translit: "Beethum muu kabeer, bass beetna kabeer" },
      { ar: "بيتهم كبير، بس بيتنا مو كبير", translit: "Beethum kabeer, bass beetna muu kabeer" },
      { ar: "بيتنا مو كبير، بس بيتهم كبير", translit: "Beetna muu kabeer, bass beethum kabeer" },
      { ar: "بيتهم ماهو كبير، بس بيتها كبير", translit: "Beethum maahu kabeer, bass beetha kabeer" },
    ],
    correctIndex: 0,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { ar: "ما فهم عشان ما كان موجود", translit: "Ma fihim 9ashaan ma kaan mawjood" },
      { ar: "ما يفهم عشان مو موجود", translit: "Ma yifham 9ashaan muu mawjood" },
      { ar: "فهم عشان كان موجود", translit: "Fihim 9ashaan kaan mawjood" },
      { ar: "ما فهم عشان ماهو موجود", translit: "Ma fihim 9ashaan maahu mawjood" },
    ],
    correctIndex: 0,
    explanation: {
