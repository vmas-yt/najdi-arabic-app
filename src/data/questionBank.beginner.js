...
export const beginnerQuestions = [
  ...
  // ---------------------------------------------------------------
  {
    ...
    options: ["Yallah", "Shukran", "Yimkin", "Abadan"],
    correctIndex: 1,
    explanation: {
  ...
  },
  {
    ...
    options: ["Shaay", "Qahwa", "Mayy", "Laban"],
    correctIndex: 2,
    explanation: {
      en: '"Mayy" is water. "Shaay" is tea, "qahwa" is coffee, "laban" is a yogurt-based drink.',
      ar: '"ماي" تعني الماء. "شاي" تعني tea، "قهوة" تعني coffee، "لبن" مشروب من الزبادي.',
    },
  },
  {
    id: "beg-vocab-004",
  ...
  // ---------------------------------------------------------------
  {
    ...
    options: ["Tifham", "Afham", "Yifham", "Nifham"],
    correctIndex: 1,
    explanation: {
  ...
  },
  {
    ...
    options: ["Tisma9", "Tisma9een", "Yisma9", "Asma9"],
    correctIndex: 1,
    explanation: {
  ...
  },
  {
    ...
    options: ["Yidrus", "Tidrusoon", "Yidrusoon", "Nidrus"],
    correctIndex: 2,
    explanation: {
  ...
  // ---------------------------------------------------------------
  {
    ...
    type: "mcq",
    category: "nouns_adjectives_with_pronouns",
    prompt: { en: 'A woman wants to say "I am happy." Which is correct?' },
    options: ["Ana mabsoot", "Ana mabsoota", "Ana mabsooteen", "Ana mabsootoon"],
    correctIndex: 1,
    explanation: {
      en: 'The pronoun "Ana" never changes, but adjectives still agree with the speaker\'s gender. A woman adds the feminine "-a": "mabsoota."',
      ar: '"أنا" لا تتغير، لكن الصفة تتفق مع جنس المتكلم. المرأة تضيف "-a" للمؤنث: "mabsoota".',
    },
  },
  {
    id: "beg-noun-002",
    ...
    options: ["Jawaalha", "Jawaalak", "Jawaali", "Jawaalkum"],
    correctIndex: 2,
    explanation: {
  ...
  },
  {
    ...
    options: ["Kitaabah", "Kitaabha", "Kitaabkum", "Kitaabhum"],
    correctIndex: 1,
    explanation: {
  ...
  // ---------------------------------------------------------------
  {
    ...
    options: ["Ashrab shaay", "Tishrab shaay", "Yishrab shaay", "Nishrab shaay"],
    correctIndex: 0,
    explanation: {
  ...
  },
  {
    ...
    options: [
      "Hiya yidrus fi al-beet",
      "Hiya tidrus fi al-beet",
      "Hiya tidruseen fi al-beet",
      "Hiya nidrus fi al-beet",
    ],
    correctIndex: 1,
    explanation: {
  ...
  },
  {
    ...
    type: "speaking",
    category: "tenses",
    prompt: { en: 'Say "we understand the lesson" in Najdi Arabic.' },
    expectedAnswer: { ar: "نحنا نفهم الدرس", translit: "niHna nifham ad-dars", en: "We understand the lesson" },
    explanation: {
  ...
  },
  {
    ...
    type: "mcq",
    category: "tenses",
    prompt: { en: 'Fix the mistake: "Inti tifham ad-dars?" What is wrong?' },
    options: [
    ...
    correctIndex: 1,
    explanation: {
      en: 'Speaking to a woman ("Inti") requires the suffix "-een" on top of "ti-": the correct form is "tifhameen ad-dars?"',
      ar: 'عند مخاطبة امرأة ("انتي") يجب إضافة اللاحقة "-een" فوق "ti-": والصيغة الصحيحة هي "tifhameen ad-dars?"',
    },
  },
];
